...
const Header = ({ isOpenMenu, setIsOpenMenu }) => {
    ...
    return (
        <header className={`${isOpenMenu ? "h-screen" : "h-[80px]"} transform transition-all duration-600 relative flex justify-between items-center text-white py-6 px-8 md:px-32 bg-[#101720] drop-shadow-md`}>
